...
sequenceDiagram
  ...
  Note left of Server: The server adds the new note to the list and asks the browser to reload the page
  Server-->>-Browser: URL Redirect to the ".../exampleapp/notes" page
